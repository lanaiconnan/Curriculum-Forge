...
### 获取租户 `GET /tenants/{tenant_id}`

**权限**: `auth.admin`

### 更新配额 `PUT /tenants/{tenant_id}/quota`
...
### 更新状态 `PUT /tenants/{tenant_id}/status`
...
### 使用统计 `GET /tenants/{tenant_id}/usage`

**权限**: `auth.admin` 或租户成员

### 功能检查 `GET /tenants/{tenant_id}/features/{feature}`
