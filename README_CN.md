# Curriculum-Forge — AI Agent Town

<p align="center">
<img src="https://img.shields.io/badge/Python-3.7+-blue.svg" alt="Python">
<img src="https://img.shields.io/badge/License-MIT-green.svg" alt="License">
<img src="https://img.shields.io/badge/Framework-GStack-green.svg" alt="GStack">
</p>

> 🏘️ **AI Agent Town — 多 Agent 协作治理系统**
> 
> 让多个 AI Agent 在"小镇"中协作、学习、进化，共同完成复杂任务。

---

## 📖 项目简介

Curriculum-Forge 正在演进为 **AI Agent Town** —— 一个多 Agent 协作系统，实现 Agent 间的协作、学习与进化。
...
```
Phase 1 ✅ 知识层基础     Syzygy Vault + Experience Generator
Phase 2 🚧 Stella 记忆增强  检索优化 + 反思循环
Phase 3 📋 治理层实现     Keeper + Mayor + Front Desk
```
...
├─────────────────────────────────────────────────────────────┤
│  治理层        │  Keeper（资源）│ Mayor（规则）│ Front Desk  │
├─────────────────────────────────────────────────────────────┤
...
| 组件 | 职责 |
|------|------|
| **Syzygy Vault** | 知识库存储，Markdown + 双向链接 |
| **Experience Generator** | 从任务执行生成经验页 |
| **Stella** | 记忆增强型 Agent，检索历史辅助决策 |
...
Curriculum-Forge 最初是 **Curriculum Learning for Tool-Using RL Agents** 框架，现在正在演进为 **AI Agent Town** 多 Agent 协作系统。
